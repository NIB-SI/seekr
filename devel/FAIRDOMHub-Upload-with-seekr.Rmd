...
If it is so, one can create the appropriate layer. Created object id is stored in options or can be found by a call to function \fct{dkFindId}.

```{r eval=(iid == 0)}
if( iid==0) skCreate("investigations", meta=.imeta)
