...
#'      that sets the option 'root' taht was used.
#' @export
#' @keywords pisa
...
#' }
#
skSetLayers <- function(path, root=.iroot ,studyForFiles="Investigation files", assaySuffix="-files"){
...
#
    ...
    return(list(pname=pl, iname=il, sname=sl, aname=al, fname=fl, 
...
#' }
#
skCheckAndCreate <- function(type, layers, root=skGetOption("root"), create = TRUE, verbose=FALSE, quiet=FALSE) {
